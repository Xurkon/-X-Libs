...
-- Register as standard AceLocale-3.0 and AceLocale-3.0-ElvUI for library compatibility
-- Use AddLib to ensure aliases work even if another version already registered the library
