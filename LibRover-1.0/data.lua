...
data.version={
	nodes_version = 675,  -- Increase this when working on the nodes. Connections will be baked automatically when committing.
}

-- These are kept strictly unique. Make up bogus names if you need to.
-- If multiple numbers are given, lowest one is used as default floor if none is given (ie Argus/0 is the same as Argus).
-- If the default map floor is not 0, you can define it using "default=10" field. (see Dalaran)
...
-----------------------------
-- zones & caves
["Atal Aman M"] = {[0]=2535, [1]=2536,},
["Eversong Woods M"] = {[0]=2395, [1]=2579},
["Harandar"] = {[0]=2413, [1]=2480, [2]=2576},
["Floaret Grotto"] = {[0]=2522, [1]=2523,},
["Isle of Quel Danas M"] = {[0]=2424, [1]=2545,},
["Isle of Quel Danas (Intro)"] = {[0]=2432,},
["March on Quel Danas"] = {[0]=2533, [1]=2534},
["Voidstorm"] = {[0]=2405, [1]=2479,},
["Slayers Rise"] = {[0]=2444,},
["Zul Aman M"] = {[0]=2437,[1]=2580},
["Silvermoon City M"] = {[0]=2393,},

-- housing
["Razorwind Shores"] = {[0]=2351,},
["Alliance Housing District"] = {[0]=2401,},
["Horde Housing District"] = {[0]=2402,},
["Founder's Point"] = {[0]=2352,},

-- delves
["Gulf Of Memory"] = {[0]=2505,},
["Sunkiller"] = {[0]=2528, [1]=2540,},
["Torments Rise"] = {[0]=2507,},
["Twilight Crypts"] = {[0]=2503, [1]=2504,},
["Twilight Tunnels"] = {[0]=2525,},
["Voidholme"] = {[0]=2502,},

-- dungeons
["Den of Nalorakk"] = {[0]=2513, [1]=2514,},
["Magisters Terrace MD"] = {[0]=2511,},
["Murder Row"] = {[0]=2433, [1]=2434, [2]=2435,},
["Maisara Caverns"] = {[0]=2501,},
["Nexus Point Xenas"] = {[0]=2556,},
["The Blinding Vale"] = {[0]=2500,},
["Windrunner Spire"] = {[0]=2492, [1]=2493, [2]=2494, [3]=2496, [4]=2497, [5]=2498, [6]=2499,},

-- raids
["Magisters Terrace MR"] = {[0]=2515, [1]=2516, [2]=2517, [3]=2518, [4]=2519, [5]=2520,},
["Dreamrift"] = {[0]=2531, [1]=2532,},
["The Voidspire"] = {[0]=2529, [1]=2530,},

-- misc
["12.0 Campaign Finale Scenario"] = {[0]=2443,},
["Legion Command Center"] = {[0]=2557, [1]=2558,},

["Shadowguard Point"] = {[0]=2506,},
["The Grudge Pit"] = {[0]=2510,},
["Void Lands"] = {[0]=2397,},
["Voidlands Abundance"] = {[0]=2526, [1]=2527,},

["Scarlet Halls Arator"] = {[0]=2438,},
["Arcantina"] = {[0]=2541,},
...
-----------------------------------
["Dornogal"] = {[0]=2339},
["Isle of Dorn"] = {[0]=2248, [1]=2271},
["The Ringing Deeps"] = {[0]=2214, [1]=2385, [2]=2272},
["Hallowfall"] = {[0]=2215},
...
["Codex of Chromie"] = {[0]=2354},
-- 11.0.7
["Siren Isle"] = {[0]=2369},
["The Forgotten Vault"] = {[0]=2375},
-- 11.1.0
["Undermine"] = {[0]=2346},
-- 11.1.5
["Vision of Orgrimmar"] = {[0]=2403},
["Vision of Stormwind"] = {[0]=2404},
["Dastardly Dome"] = {[0]=2447},
-- 11.1.7
["Red Dawn Arathi"] = {[0]=2372},
["Lorewalking Ny'alotha"] = {[0]=2384, [1]=2381, [2]=2383, [3]=2382, [4]=2379},
["Lorewalking Scarlet Halls"] = {[0]=2418},
-- 11.2.0
["Tazavesh"] = {[0]=2472},
["K'aresh"] = {[0]=2371},
["Voidscar Cavern"] = {[0]=2477},
-- 11.2.7
["Founder's Point"] = {[0]=2352},
["Razorwind Shores"] = {[0]=2351},
["Arathi Highlands New"] = {[0]=2451},
["The Wandering Isle Heritage"] = {[0]=2366},
		...
		["The Sinkhole"] = {[0]=2301, [1]=2300},
		["Mycomancer Cavern"] = {[0]=2312},
		["Nightfall Sanctum"] = {[0]=2277},
		["Skittering Breach"] = {[0]=2310},
		["The Spiral Weave"] = {[0]=2347, [1]=2313},
		["The Underkeep"] = {[0]=2299},
		["Tak-Rethan Abyss"] = {[0]=2259, [1]=2314},
		["Excavation Site 9"] = {[0]=2396},
		["Sidestreet Sluice"] = {[0]=2420, [1]=2421, [2]=2422, [3]=2423},
		["Archival Assault"] = {[0]=2476, [1]=2455, [2]=2454, [3]=2452, [4]=2453},
		...
		["Operation: Floodgate"] = {[0]=2388, [1]=2387},
		["Eco-Dome Al'dani"] = {[0]=2449},

		--Raid--
		["Nerub'ar Palace"] = {[0]=2291, [1]=2293, [2]=2292, [3]=2294, [4]=2295, [5]=2296, [6]=2298},
		["Liberation of Undermine"] = {[0]=2406, [1]=2407, [2]=2408, [3]=2411, [4]=2409, [5]=2428},
		["Manaforge Omega"] = {[0]=2460, [1]=2462, [2]=2461, [3]=2463, [4]=2464, [5]=2465, [6]=2466, [7]=2467, [8]=2471, [9]=2468, [10]=2469, [11]=2470},
...
-------    DRAGONFLIGHT   -------
---------------------------------
["The Forbidden Reach"] = {[0]=2118, [1]=2107, [2]=2026, [3]=2110, [4]=2109, [5]=2151, [6]=2131},
...
["The Support Creche"]={[0]=2101, [1]=2111},
["The Siege Creche"]={[0]=2100},
["Froststone Vault"]={[0]=2154},
["The War Creche"]={[0]=2102, [1]=2373, },

["Dragonskull Island"]={[0]=2150},
["Zaralek Cavern"]={[0]=2133},
["The Throughway"]={[0]=2165},
["Deepflayer Nest"]={[0]=2184},
["Aberrus, the Shadowed Crucible"]={[0]=2166, [1]=2167, [2]=2168, [3]=2169, [4]=2170, [5]=2171, [6]=2172, [7]=2173, [8]=2174, [9]=2211},
...
["Amirdrassil, The Dream's Hope"]={[0]=2244, [1]=2240, [2]=2232, [3]=2233, [4]=2234, [5]=2238, [6]=2237, [7]=2236, [8]=2235, [9]=2268},
...
["Ardenweald"] = {[0]=1565, [1]=1829, [2]=1818, [3]=1824, [4]=1709, [5]=1603, [6]=1643, [7]=1739, [8]=1740},
["Revendreth"] = {[0]=1525},
["Ember Court"] = {[0]=1644},
["The Maw"] = {[0]=1543},
...
["Camp Narache"] = {[0]=462},
["Darkshore"] = {[0]=62},
["Darkshore Scenario"] = {[0]=1338, [1]=1343},
["Darnassus"] = {[0]=89},
...
["Crumbling Depths"]={[0]=729},					-- Shaman Enhancement Legion artifact scenario map
...
-- /run D={}  for i=1,1000 do pcall(EJ_SelectInstance,i) local _, _, _, _, _, _, dungeonMapId, _ = EJ_GetInstanceInfo()  D[dungeonMapId or 0]=true end  XP:ShowDump(XP:Serialize(D),"")
...
----------------------------
-- Caves
	{"Voidlands Abundance/0","Voidlands Abundance/1"},
	{"Harandar/0","Harandar/2"},					-- The Den
	{"Floaret Grotto/0","Floaret Grotto/1"},				-- Floaret Grotto
...
-- Khaz Algar Main Zones
	...
	{"Tazavesh/0","K'aresh/0", cond=function() return not C_UnitAuras.GetPlayerAuraBySpellID(1214374) end}, -- green only while not phase diving
...
-- Highmountain
	...
	{"Highmountain/0","Highmountain/21"},
...
-- Nazjatar
	{"Nazjatar/0","Orgrimmar Collapse Scenario/0"},
...
data.walls = {
	...
	["K'aresh"] = {
		{ 00.00,12.00, 51.27,33.02, 56.08,35.60, 62.22,32.68, 80.50,02.32, cond=function() return C_UnitAuras.GetPlayerAuraBySpellID(1214374) end }, -- cut off north phased island
		{ 56.08,35.60, 55.00,40.50, 00.00,55.00, cond=function() return C_UnitAuras.GetPlayerAuraBySpellID(1214374) end }, -- cut off small phased island
		{ 56.08,35.60, 58.30,50.10, 62.55,53.85, 64.33,64.61, cond=function() return C_UnitAuras.GetPlayerAuraBySpellID(1214374) end }, -- cut off east and west phased island
		{ 33.00,99.00, 64.33,64.61, 99.00,77.00, cond=function() return C_UnitAuras.GetPlayerAuraBySpellID(1214374) end }, -- cut off south phased island
	},
}
...
data.ZoneMeta = {
	...
	["Harandar/2"] = {flyable=true},		-- The Den
	...
	["Isle of Quel Danas (Intro)/0"] = {flyable=false},

	["Arcantina/0"] = {flyable=true},
...
[123] = true, [123]=11111, -- whistle valid if quest completed
...
data.RemapData = {
	...
	[619] = { -- broken island 
		...
		{top=-1132.8970947266, bottom=-1384.7160644531, left=4669.2470703125, right=4417.4267578125, target=627, cond=function() return XP.IsLegionRemix() end },
	},
	...
	[2381] = { --Ny'alotha Lorewalking bad floor transition
		{top=-234.11755371094, bottom=-391.20672607422, left=304.00421142578, right=56.190704345703, target=2382},
	},
	[18] = { -- tirisfal glades
		{left=1700, right=1640, top=1685, bottom=1600, target=465}, -- Deathknell crypt, Undead starter
	},
	[694] = {
		{top=5177.080078125, bottom=-381697.9375, left=5033.330078125, right=-575174.6875, target=634}, -- hellmouth shallows to stormheim
	},
}
