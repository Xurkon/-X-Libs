...
data.basenodes.DungeonEntrances = --[[LIBROVER]] {
	-- DUNGEON ENTRANCE/EXITS
		...
		--Kalimdor
			...
			"Uldum New/0 76.84,84.61 -x- The Vortex Pinnacle/1 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldUldum')}",
			-- HALLS OF ORIGINATION
			"Uldum 69.09,52.97 -x- Halls of Origination 49.91,93.73 {autotype:portal_dungeon}",
			"Uldum New/0 69.09,53.15 -x- Halls of Origination/1 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldUldum')}",

			-- LOST CITY OF THE TOL'VIR
			"Uldum 60.55,64.32 -x- Lost City of the Tol'vir 31.78,16.78 {autotype:portal_dungeon}",
			"Uldum New/0 60.55,64.32 -x- Lost City of the Tol'vir/0 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldUldum')}",

			--Ny'alotha, The Waking City
			"Uldum New/0 55.17,43.93 -x- Ny'alotha, the Waking City/10 0.00,0.00 {autotype:portal_dungeon} {cond:XP.InPhase('UldumInvasionCenter')}",
		...
		--Pandaria
			...
			"Vale of Eternal Blossoms New/0 81.60,29.88 -x- Mogu'shan Palace/1 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldVale')}",
			...
			--Ny'alotha, The Waking City
			"Vale of Eternal Blossoms New/0 40.08,45.52 -x- Ny'alotha, the Waking City/10 0.00,0.00 {autotype:portal_dungeon} {cond:XP.InPhase('ValeInvasionRight')}",
		...
		--The War Within
			...
			--Darkflame Cleft--
			"The Ringing Deeps/0 55.50,21.50 -x- Darkflame Cleft/0 16.52,68.90 {autotype:portal_dungeon}",
			--The Stonevault--
			"The Ringing Deeps/0 42.70,8.39 -x- The Stonevault/0 53.44,10.68 {autotype:portal_dungeon}",
			--The Dawnbreaker--
			...
			--Operation: Floodgate--
			"The Ringing Deeps/0 42.02,39.39 -x- Operation: Floodgate/1 42.25,11.73 {autotype:portal_dungeon}",
			--Tazavesh, the Veiled Market (TWW)--
			"Tazavesh/0 36.41,11.99 -x- Tazavesh, the Veiled Market/7 0.00,0.00 {autotype:portal_dungeon}",
			--Eco-Dome Al'dani--
			"Tazavesh/0 43.88,3.76 -x- Eco-Dome Al'dani/0 0.00,0.00 {autotype:portal_dungeon}",
	...
	-- RAID ENTRANCE/EXITS
		...
		--Cata
			...
			"Uldum New/0 38.25,80.69 -x- Throne of the Four Winds/1 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldUldum')}",
		...
		--Pandaria
			...
			--Siege of Orgrimmar
			"Vale of Eternal Blossoms/0 73.96,42.15 -x- Siege of Orgrimmar/1 0.00,0.00 {autotype:portal_dungeon} {cond:XP.InPhase('OldVale')}",
			"Vale of Eternal Blossoms New/0 72.86,41.91 -x- Siege of Orgrimmar/1 0.00,0.00 {autotype:portal_dungeon} {cond:not XP.InPhase('OldVale')}",
		...
		--Legion
			...
			"Krokuun/0 73.44,33.84 -x- Invasion Point Sangua/0 24.18,50.61 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5350)}",
			"Invasion Point Sangua/0 50.91,48.01 -x- Krokuun/0 73.44,33.84 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5350)}",
			--Invasion Point: Sangua (Antoran Wastes)
			"Antoran Wastes/0 67.03,33.31 -x- Invasion Point Sangua/0 24.18,50.61 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5369)}",
			"Invasion Point Sangua/0 50.91,48.01 -x- Antoran Wastes/0 67.03,33.31 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5369)}",
			--Invasion Point: Val (Krokuun)
			"Krokuun/0 38.49,60.97 -x- Invasion Point Val/0 38.78,74.46 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5360)}",
			"Invasion Point Val/0 55.07,35.85 -x- Krokuun/0 38.49,60.97 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5360)}",
			--Invasion Point: Val (Antoran Wastes)
			"Antoran Wastes/0 72.68,65.22 -x- Invasion Point Val/0 38.78,74.46 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5372)}",
			"Invasion Point Val/0 55.07,35.85 -x- Antoran Wastes/0 72.65,65.33 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5372)}",
			--Invasion Point: Naigtal (Eredath)
			"Eredath/0 70.51,38.47 -x- Invasion Point Naigtal/0 25.20,29.85 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5368)}",
			"Invasion Point Naigtal/0 71.95,57.46 -x- Eredath/0 70.51,38.47 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5368)}",
			--Invasion Point: Naigtal (Antoran Wastes)
			"Antoran Wastes/0 55.35,29.53 -x- Invasion Point Naigtal/0 25.20,29.85 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5374)}",
			"Invasion Point Naigtal/0 71.95,57.46 -x- Antoran Wastes/0 55.35,29.53 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5374)}",
			--Invasion Point: Cen'gar (Antoran Wastes)
			"Antoran Wastes/0 60.24,42.98 -x- Invasion Point Cen'gar/0 27.39,28.40 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5370)}",
			"Invasion Point Cen'gar/0 65.76,69.57 -x- Antoran Wastes/0 60.24,42.98 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5370)}",
			--Invasion Point: Cen'gar (Krokuun)
			"Krokuun/0 68.66,81.80 -x- Invasion Point Cen'gar/0 27.39,28.40 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5359)}",
			"Invasion Point Cen'gar/0 65.76,69.57 -x- Krokuun/0 68.66,81.80 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5359)}",
			--Invasion Point: Bonich (Eredath)
			"Eredath/0 61.01,18.74 -x- Invasion Point Bonich/0 69.54,63.16 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5366)}",
			"Invasion Point Bonich/0 45.39,48.18 -x- Eredath/0 61.01,18.74 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5366)}",
			--Invasion Point: Bonich (Antoran Wastes)
			"Antoran Wastes/0 55.75,19.28 -x- Invasion Point Bonich/0 69.54,63.16 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5371)}",
			"Invasion Point Bonich/0 45.39,48.18 -x- Antoran Wastes/0 55.75,19.28 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5371)}",
			--Invasion Point: Aurinor (Antoran Wastes)
			"Antoran Wastes/0 64.59,69.16 -x- Invasion Point Aurinor/0 81.75,39.02 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5373)}",
			"Invasion Point Aurinor/0 20.45,52.72 -x- Antoran Wastes/0 64.59,69.16 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5373)}",
			--Invasion Point: Aurinor (Eredath)
			"Eredath/0 38.82,12.52 -x- Invasion Point Aurinor/0 81.75,39.02 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5367)}",
			"Invasion Point Aurinor/0 20.45,52.72 -x- Eredath/0 38.82,12.52 <subtype:portalclick> {mode:PORTAL} {cond:XP:IsPOIActive(5367)}",
		...
		--The War Within
			...
			"Undermine/0 42.11,50.41 -x- Liberation of Undermine/0 42.60,52.29 {autotype:portal_dungeon}",
			--Manaforge Omega--
			"K'aresh/0 41.71,21.53 -x- Manaforge Omega/0 76.81,9.50 {autotype:portal_dungeon}",


	-- DELVE ENTRANCE/EXITS
			--The Spiral Weave--
			"Azj-Kahet/0 45.05,18.76 -x- The Spiral Weave/0 56.28,93.17 {autotype:portal_dungeon}",
			--Tak-Rethan Abyss--
			"Nerub'ar/0 67.66,24.65 -x- Tak-Rethan Abyss/0 52.74,12.96 {autotype:portal_dungeon}",
			--The Underkeep--
			"Nerub'ar/1 58.67,66.68 -x- The Underkeep/0 31.90,21.39 {autotype:portal_dungeon}",
			--Earthcrawl Mines--
			"Isle of Dorn/0 38.55,73.93 -x- Earthcrawl Mines/0 46.20,9.54 {autotype:portal_dungeon}",
			--Fungal Folly--
			"Isle of Dorn/0 51.87,65.51 -x- Fungal Folly/0 68.99,89.03 {autotype:portal_dungeon}",
			--Kriegval's Rest--
			"Isle of Dorn/0 62.17,42.72 -x- Kriegval's Rest/0 31.49,26.85 {autotype:portal_dungeon}",
			--The Dread Pit--
			"The Ringing Deeps/0 70.26,37.15 -x- The Dread Pit/0 24.81,63.98 {autotype:portal_dungeon}",
			--The Waterworks--
			"The Ringing Deeps/0 42.18,48.68 -x- The Waterworks/0 46.53,10.58 {autotype:portal_dungeon}",
			--Excavation Site 9--
			"The Ringing Deeps/0 76.81,98.29 -x- Excavation Site 9/0 48.75,3.62 {autotype:portal_dungeon}",
			--Skittering Breach--
			"Hallowfall/0 65.42,61.69 -x- Skittering Breach/0 83.68,54.72 {autotype:portal_dungeon}",
			--Earthcrawl Mines--
			"Hallowfall/0 71.37,31.15 -x- Mycomancer Cavern/0 14.00,35.80 {autotype:portal_dungeon}",
			--The Sinkhole--
			"Hallowfall/0 50.70,53.56 -x- The Sinkhole/0 51.59,5.75 {autotype:portal_dungeon}",
			--Nightfall Sanctum--
			"Hallowfall/0 34.28,47.31 -x- Nightfall Sanctum/0 80.80,16.25 {autotype:portal_dungeon}",
			--Sidestreet Sluice--
			"Undermine/0 35.19,51.44 -x- Sidestreet Sluice/0 48.89,71.44 {autotype:portal_dungeon}",
			--Excavation Site 9--
			"The Ringing Deeps/0 76.82,98.29 -x- Excavation Site 9/0 48.75,3.63 {autotype:portal_dungeon}",
			--Kyveza's Voidrazor Sanctuary--
			--"Tazavesh/0 38.28,51.16 -x- Kyveza's Voidrazor Sanctuary/0 48.75,3.63 {autotype:portal_dungeon}",
			--Archival Assault--
			"K'aresh/0 55.09,48.07 -x- Archival Assault/3 39.17,88.46 {autotype:portal_dungeon} {title_atob:Click Enter Delve} {title_btoa:Click Leave Delve}",
}
...
data.basenodes.DungeonFloors = --[[LIBROVER]] {
	-- Dungeons
		...
		["Operation: Floodgate"] = {
			"Operation: Floodgate/1 51.05,80.27 <radius:15> -x- Operation: Floodgate/0 42.13,16.32 <radius:15>",
		},
	...
	--Raids
		...
		-------------------------------
		["Liberation of Undermine"] = {
			"Liberation of Undermine/0 66.92,44.80 -x- Liberation of Undermine/1 16.55,53.52",
			"Liberation of Undermine/1 87.57,54.59 -x- Liberation of Undermine/2 10.45,48.60",
			"Liberation of Undermine/2 86.49,40.89 -x- Liberation of Undermine/3 50.86,13.70",
			"Liberation of Undermine/3 50.77,87.61 -x- Liberation of Undermine/4 53.13,6.28",
			"Liberation of Undermine/0 50.62,43.11 -x- Liberation of Undermine/5 44.05,27.62",
		},
		...
		-----------------------
		["Manaforge Omega"] = {
			"Manaforge Omega/0 23.48,77.91 -x- Manaforge Omega/1 34.24,20.62",
			"Manaforge Omega/0 23.48,24.64 -x- Manaforge Omega/2 75.37,79.63",
			"Manaforge Omega/0 15.23,51.18 -x- Manaforge Omega/3 62.34,53.80",
			"Manaforge Omega/3 30.89,68.69 -x- Manaforge Omega/4 44.88,65.35",
			"Manaforge Omega/4 24.57,48.85 -x- Manaforge Omega/5 66.28,57.75",
			"Manaforge Omega/5 57.32,21.52 -x- Manaforge Omega/6 28.98,9.04",
			"Manaforge Omega/6 83.14,56.03 -x- Manaforge Omega/7 4.95,48.42",
			"Manaforge Omega/7 75.61,49.14 -to- Manaforge Omega/8 65.57,69.05",
			"Manaforge Omega/8 36.15,52.01 -x- Manaforge Omega/9 61.26,55.85",
			"Manaforge Omega/8 85.77,45.37 -x- Manaforge Omega/10 37.11,51.36",
			"Manaforge Omega/8 60.78,49.32 -to- Manaforge Omega/11 55.88,68.76",
			"Manaforge Omega/11 56.00,68.76 -to- Manaforge Omega/7 72.14,48.78",
		},
		...
		-------------------------
		["Sidestreet Sluice"] = {
			"Sidestreet Sluice/3 50.95,45.55 -x- Sidestreet Sluice/0 44.22,41.58 {title_atob:Jump down the hole and quickly exit the ooze} {title_btoa:Click the Explorers' League Rope}",
			"Sidestreet Sluice/0 34.07,21.28 -x- Sidestreet Sluice/1 46.85,20.85",
			"Sidestreet Sluice/0 71.62,18.47 -x- Sidestreet Sluice/1 71.72,30.62",
			"Sidestreet Sluice/1 38.90,70.51 -x- Sidestreet Sluice/2 27.91,70.05",
			"Sidestreet Sluice/1 71.05,18.06 -x- Sidestreet Sluice/2 70.95,28.86",
		},
		...
		------------------------
		["Archival Assault"] = {
			"Archival Assault/3 61.50,21.23 -x- Archival Assault/4 54.09,31.03",
			"Archival Assault/3 52.38,59.72 -x- Archival Assault/2 45.60,53.42 {title_atob:Click the Descending Waygate} {title_btoa:Click the Ascending Waygate}",
			"Archival Assault/2 49.34,54.84 -x- Archival Assault/1 41.94,50.37 {title_atob:Click the Descending Waygate} {title_btoa:Click the Ascending Waygate}",
			"Archival Assault/1 45.00,50.19 -x- Archival Assault/0 51.84,51.84 {title_atob:Click the Descending Waygate} {title_btoa:Click the Ascending Waygate}",
		},
}
