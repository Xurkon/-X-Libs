...
data.basenodes.borders = --[[LIBROVER]] {
	...
	-- TWW
		...
		"K'aresh/0 56.84,24.09 -x- Voidscar Cavern/0 33.80,83.85 {title_atob:Enter the cave} {title_btoa:Leave the cave}",
	...
	-- Kalimdor
		...
		"Tanaris/0 25.98,66.23 -x- Uldum New/0 70.51,22.43 {cond:not XP.InPhase('OldUldum')}",
	...
	-- Pandaria
		...
		"Kun-Lai Summit/0 55.54,92.77 -x- Vale of Eternal Blossoms New/0 44.12,10.42 {cond:not XP.InPhase('OldVale')}",
...
-----------------------------------------------
	"Dornogal/0 38.87,59.81 <radius:20> <border_in_flight:true> -x- The Ringing Deeps/0 38.03,28.36 <radius:40> <border_in_flight:true> {cost:20} "..
	...
	"The Ringing Deeps/0 36.42,24.25 <radius:50> <border_in_flight:true> -x- Hallowfall/0 79.24,41.94 <radius:50> <border_in_flight:true> {title_atob:Fly through the tunnel into Hallowfall} {title_btoa:Fly through the tunnel into the Ringing Deeps}",
	...
	"The Ringing Deeps/0 38.58,67.00 <radius:50> <border_in_flight:true> -x- Azj-Kahet/0 68.00,28.00 <radius:50> <border_in_flight:true> {title_atob:Fly down the huge hole|ninto Azj-Kahet} {title_btoa:Fly up the green rocks into|nthe Ringing Deeps, using wind boosts}",
