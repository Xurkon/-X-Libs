...
---------------------
	...
	-------------------------------------------
		...
		--"Tanaris/0 62.34,49.42 -x- Val'sharah/0 53.90,67.59 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nVal'sharah} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Stormheim
		--"Tanaris/0 62.39,49.37 -x- Stormheim/0 37.40,47.46 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nStormheim} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Suramar
		--"Tanaris/0 62.45,49.32 -x- Suramar/0 38.41,42.95 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nSuramar} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Stormsong Valley
		--"Tanaris/0 62.34,49.42 -x- Stormsong Valley/0 57.86,44.79 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nStormsong Valley} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Drustvar
		--"Tanaris/0 62.39,49.37 -x- Drustvar/0 36.91,41.40 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nDrustvar} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Tiragarde Sound
		--"Tanaris/0 62.45,49.32 -x- Tiragarde Sound/0 79.97,22.18 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nTiragarde Sound} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Zereth Mortis
		--"Tanaris/0 62.34,49.42 -x- Zereth Mortis/0 64.65,53.92 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nZereth Mortis} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Ardenweald
		--"Tanaris/0 62.39,49.37 -x- Ardenweald/0 68.21,19.93 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nArdenweald} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Revendreth
		--"Tanaris/0 62.45,49.32 -x- Revendreth/0 65.95,57.53 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nRevendreth} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Ohn'ahran Plains
		--"Tanaris/0 62.34,49.42 -x- Ohn'ahran Plains/0 36.94,57.47 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nOhn'ahran Plains} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Waking Shores
		--"Tanaris/0 62.39,49.37 -x- The Waking Shores/0 33.26,76.53 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nWaking Shores} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Azure Span
		--"Tanaris/0 62.45,49.32 -x- The Azure Span/0 67.08,34.81 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nAzure Span} {title_btoa:Click the Portal to\nCaverns of Time Atop the Tower}",
	
		-- Caverns of Time -x- Twilight Highlands
		--"Tanaris/0 62.34,49.42 -x- Twilight Highlands/0 59.59,16.82 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nTwilight Highlands} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Uldum
		--"Tanaris/0 62.39,49.37 -x- Uldum New/0 69.92,34.70 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nUldum} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Mount Hyjal
		--"Tanaris/0 62.45,49.32 -x- Mount Hyjal/0 34.22,30.90 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nMount Hyjal} {title_btoa:Click the Portal to\nCaverns of Time}",

		-- Caverns of Time -x- Nagrand
		--"Tanaris/0 62.34,49.42 -x- Nagrand D/0 73.10,12.53 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nNagrand} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Gorgrond
		--"Tanaris/0 62.39,49.37 -x- Gorgrond/0 37.89,57.10 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nGorgrond} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Shadowmoon Valley
		--"Tanaris/0 62.45,49.32 -x- Shadowmoon Valley D/0 68.70,55.07 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nShadowmoon Valley} {title_btoa:Click the Portal to\nCaverns of Time Atop the Tower}",
	
		-- Caverns of Time -x- The Storm Peaks
		--"Tanaris/0 62.34,49.42 -x- The Storm Peaks/0 31.53,40.26 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nThe Storm Peaks} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Icecrown
		--"Tanaris/0 62.39,49.37 -x- Icecrown/0 49.35,72.64 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nIcecrown} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Grizzly Hills
		--"Tanaris/0 62.45,49.32 -x- Grizzly Hills/0 64.30,42.97 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nGrizzly Hills} {title_btoa:Click the Portal to Caverns\nof Time on the Tower}",

		-- Caverns of Time -x- Valley of the Four Winds
		--"Tanaris/0 62.34,49.42 -x- Valley of the Four Winds/0 43.99,18.36 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nValley of the Four Winds} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- Kun-Lai Summit
		--"Tanaris/0 62.39,49.37 -x- Kun-Lai Summit/0 67.84,57.77 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nKun-Lai Summit} {title_btoa:Click the Portal to\nCaverns of Time}",
	
		-- Caverns of Time -x- The Jade Forest
		--"Tanaris/0 62.45,49.32 -x- The Jade Forest/0 41.89,61.11 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to\nThe Jade Forest} {title_btoa:Click the Portal to\nCaverns of Time}",
	...
	----------------------------
		...
		---------------------------
			--## ALLIANCE ##--
				...
				-- Silvermoon City -to- Stormwind City
					"Silvermoon City M/0 52.63,64.51 -to- @sw_tp_dst {fac:A} {mode:PORTAL}"..
					"{title:Click the Portal to Stormwind\nInside the Building}"..
					"{cond:PlayerCompletedQuest(86852)}",
				
				-- Stormwind City -to- Silvermoon City
					"Stormwind City/0 48.77,95.23 <region:magetower> -to- Silvermoon City M/0 52.85,65.51 {fac:A} {mode:PORTAL}"..
					"{title:Click the Portal to Silvermoon\nInside the Portal Room}"..
					"{cond:PlayerCompletedQuest(86852)}",
				
				
			--## HORDE ##--
				
				-- Silvermoon City -to- Orgrimmar
					"Silvermoon City M/0 52.17,65.21 -to- @org_tp_dst {fac:H} {mode:PORTAL}"..
					"{title:Click the Portal to Orgrimmar\nInside the Building}"..
					"{cond:PlayerCompletedQuest(86852)}",
					
				-- Orgrimmar -to- Silvermoon City
					"Orgrimmar/1 55.96,88.19 -to- Silvermoon City M/0 52.85,65.51 {fac:H} {mode:PORTAL}"..
					"{title:Click the Portal to Silvermoon\n Downstairs Inside the Portal Room}"..
					"{cond:PlayerCompletedQuest(86852)}",
				
				
			--## Neutral ##--
			
				-- Silvermoon City -to- Harandar
					"Silvermoon City M/0 36.96,67.99 -to- Harandar/0 53.14,55.35 {mode:PORTAL}"..
					"{title:Click the Rootway to Harandar}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41804)}",
					--"{cond:PlayerCompletedQuest(86898)}",
					
				-- Silvermoon City -to- Voidstorm
					"Silvermoon City M/0 35.28,66.18 -to- Voidstorm/0 51.64,70.20 {mode:PORTAL}"..
					"{title:Click the Portal to Voidstorm}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41806)}",
					--"{cond:PlayerCompletedQuest(86510)}",
		...
		--------------------------
			...
			--## Neutral ##--
				...
				-- Eversong Woods -to- Watha'nan Crypts								--havebuff Blessing of Abundance##1229266
					"Eversong Woods M/0 56.73,65.78 -to- Eversong Woods M/1 90.16,35.26 {mode:PORTAL}"..
					"{title_atob:Talk to Dundun\nClick the Harvest Button\nWalk into the Crypt}"..
					"{cond:PlayerCompletedQuest(91933)}",								-- Watha'nan Crypts (Abundance)
		...
		--------------------
			...
			--## Neutral ##--
				...
				-- Eversong Woods -to- Harandar
					"Eversong Woods M/0 45.14,46.93 -to- Harandar/0 75.70,53.64 {mode:PORTAL}"..
					"{title:Click the Mysterious Rootway\nto Travel to Harandar}"..
					"{cond:(PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)) and not PlayerCompletedQuest(86898)}",		-- Initial portal, disables later
					
				-- Harandar -to- Eversong Woods
					"Harandar/0 75.88,54.84 -to- Eversong Woods M/0 45.17,46.97 {mode:PORTAL}"..
					"{title:Click the Eversong Rootway\nInside the Cave}"..
					"{cond:(PlayerCompletedQuest(86883) or PlayerIsOnQuest(86883)) and not PlayerCompletedQuest(86897)}",		-- Initial portal, disables later
				
				-- Harandar -to- Silvermoon City (The Den)
					"Harandar/0 53.36,55.42 -to- Silvermoon City M/0 36.57,68.80 {mode:PORTAL}"..
					"{title:Click the Eversong Rootway\nInside The Den}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41804) or PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
					--"{cond:PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
				
				-- Harandar -to- Voidstorm (The Den)
					"Harandar/0 53.36,55.42 -to- Voidstorm/0 51.64,70.20 {mode:PORTAL}"..
					"{title:Click the Portal to Voidstorm\nInside The Den}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41806)}",
					--"{cond:PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
					
				-- Harandar -to- Floaret Grotto								--havebuff Blessing of Abundance##1229266
					"Harandar/0 66.16,61.69 -to- Floaret Grotto/0 29.55,88.49 {mode:PORTAL}"..
					"{title_atob:Talk to Dundun\nClick the Harvest Button\nWalk into the Cave}"..
					"{cond:PlayerCompletedQuest(91933)}",								-- Floaret Grotto (Abundance)
		...
		--------------------
			...
			--## Neutral ##--
				...
				-- Zul'Aman -to- Loaknit Den								--havebuff Blessing of Abundance##1229266
					"Zul Aman M/0 31.57,26.06 -to- Zul Aman M/1 76.65,72.78 {mode:PORTAL}"..
					"{title_atob:Talk to Dundun\nClick the Harvest Button\nWalk into the Cave}"..
					"{cond:PlayerCompletedQuest(91933)}",								-- Loaknit Den (Abundance)
		...
		---------------------
			...
			--## Neutral ##--
				-- Arcantina -to- Silvermoon City
					"Silvermoon City M/0 45.66,69.73 @arcantina_exit <onlyhardwire_to:true>", -- dynamic, gets updated when key is used

					"Arcantina/0 50.61,88.88 -to- @arcantina_exit {mode:PORTAL}"..
					"{title:Walk into the Portal\nInside the Arcantina}"..
					"{cond:LibRover.Arcantina:Ready()}",
		...
		---------------------
			...
			--## Neutral ##--
				-- Silvermoon City -to- Voidstorm
					"Silvermoon City M/0 35.28,66.15 -to- Voidstorm/0 34.20,60.53 {mode:PORTAL}"..
					"{title:Click the Portal to Voidstorm}"..
					"{cond:(PlayerCompletedQuest(86549) or PlayerIsOnQuest(86549)) and not PlayerCompletedQuest(86510)}",		-- Initial portal, disables later
					
				-- Voidstorm -to- Silvermoon City
					"Voidstorm/0 33.98,60.68 -to- Silvermoon City M/0 35.28,65.14 {mode:PORTAL}"..
					"{title:Walk into the Void Whirlpool\nto Travel to Silvermoon City}"..
					"{cond:(PlayerCompletedQuest(86549) or PlayerIsOnQuest(86549)) and not PlayerCompletedQuest(86510)}",		-- Initial portal, disables later				
				
				-- Voidstorm -to- Silvermoon City (Howling Ridge)
					"Voidstorm/0 51.56,70.29 -to- Silvermoon City M/0 35.30,65.23 {mode:PORTAL}"..
					"{title:Click the Portal to Silvermoon}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41806)}",
					--"{cond:PlayerCompletedQuest(86510) or PlayerIsOnQuest(86510)}",
				
				-- Voidstorm -to- Harandar (Howling Ridge)
					"Voidstorm/0 51.71,70.40 -to- Harandar/0 53.14,55.35 {mode:PORTAL}"..
					"{cond:XP.Parser.ConditionEnv.achieved(41804)}",
					--"{cond:PlayerCompletedQuest(86510) or PlayerIsOnQuest(86510)}",
		...
		---   PLAYER HOUSING   ---
		--------------------------
			-- those nodes get updated once we know where player house is, and where they teleported from
			"Razorwind Shores/0 54.31,49.32 @player_house_horde <onlyhardwire_to:true>",
			"Founder's Point/0 57.43,26.62 @player_house_alliance <onlyhardwire_to:true>",
			"Orgrimmar/1 58.98,89.53 @player_house_exit <onlyhardwire_to:true>",
	...
	--## Neutral ##--
		...
		-- Dalaran -to- Dalaran
		"Dalaran L/10 47.56,70.31 -x- Dalaran L/10 46.48,113.78 {mode:PORTAL} {title_atob:Click the Portal to the Infinite Bazaar} {cost:3}"..			-- Legion Remix Dalaran Island Portal
			"{title_btoa:Click the Portal to Dalaran} {cond:PlayerCompletedQuest(91962) and XP.IsLegionRemix()}",
			
		-- Dalaran -to- Dalaran
		"Dalaran L/10 72.04,40.47 -to- Dalaran L/10 46.48,113.78 {mode:PORTAL} {title_atob:Click the Portal to the Infinite Bazaar} {cost:3}"..			-- Legion Remix Dalaran Island Portal
			"{title_btoa:Click the Portal to Dalaran} {cond:PlayerCompletedQuest(91962) and XP.IsLegionRemix()}",
	...
	--## ALLIANCE ##--
		...
		-- Twilight Highlands -to- Stormwind City
		"Twilight Highlands/0 50.17,81.66 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind\nInside the Building}"..
		"{cond:PlayerCompletedQuest(90762)}",


	--## HORDE ##--
	
		-- Twilight Highlands -to- Orgrimmar
		"Twilight Highlands/0 49.22,81.02 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar\nInside the Tent}"..
		"{cond:PlayerCompletedQuest(90763)}",


	--## Neutral ##--
	
		-- Twilight Highlands -to- Dornogal
		"Twilight Highlands/0 49.51,81.77 -to- Dornogal/0 41.29,27.45 {mode:PORTAL} {title:Click the Portal to Dornogal\nInside the Tent}"..
		"{cond:PlayerCompletedQuest(90763) or PlayerCompletedQuest(90762)}",
	...
	--## ALLIANCE ##--
		...
		"{cond:(PlayerLevel() >= 70 and PlayerCompletedQuest(80321)) or (PlayerLevel() >= 70 and PlayerCompletedQuest(79573))}",
	
		-- Stormwind City -to- Dornogal
		"Stormwind City/0 48.13,91.95 <region:magetower> -to- Dornogal/0 41.29,27.45 {fac:A} {mode:PORTAL} {title:Click the Portal to Dornogal\nInside the Stormwind Portal Room}"..
		"{cond:(PlayerLevel() >= 70 and PlayerCompletedQuest(80321)) or (PlayerLevel() >= 70 and PlayerCompletedQuest(79573))}",

		-- Dornogal -to- Elwynn Forest
		"Dornogal/0 48.61,48.62 -to- Elwynn Forest/0 34.48,51.42 {mode:PORTAL} {fac:A} {title:Click the Scenic Getaway Portal and choose The Gala of Gifts}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",
	...
	--## HORDE ##--
		...
		"Orgrimmar/1 58.58,91.36 -to- Dornogal/0 41.29,27.45 {fac:H} {mode:PORTAL} {title:Click the Portal to Dornogal\nInside the Pathfinder's Den} {cost:30}"..   -- portal_time + 20s downstairs penality
		"{cond:(PlayerLevel() >= 70 and PlayerCompletedQuest(80321)) or (PlayerLevel() >= 70 and PlayerCompletedQuest(79573))}",

		-- Dornogal -to- Durotar
		"Dornogal/0 48.61,48.62 -to- Durotar/0 41.43,16.61 {mode:PORTAL} {fac:H} {title:Click the Scenic Getaway Portal and choose The Gala of Gifts}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",
	...
	--## Neutral ##--
		...
		-- Tazavesh -to- The Maw
		"Tazavesh/0 60.34,93.45 -x- The Maw/0 24.89,36.95 {mode:PORTAL} {title_atob:Click the Maw Gateway} {title_btoa:Click the K'areshi Gateway}"..
			"{cond:PlayerCompletedQuest(85214) or PlayerIsOnQuest(85214)}",

		-- Dornogal -to- Tazavesh
		"Dornogal/0 40.31,22.70 -x- Tazavesh/0 62.58,94.40 {mode:PORTAL} {title_atob:Click the Spatial Rift} {title_btoa:Go through the portal}"..
			"{cond:PlayerCompletedQuest(84957) or PlayerIsOnQuest(84957)}",
		...
		-- The Timeways -to- Bastion
		--"Millenia's Threshold/0 74.37,47.17 -to- Bastion/0 46.86,49.16 {mode:PORTAL}",

		-- The Timeways -to- Tiragarde Sound
		--"Millenia's Threshold/0 70.46,72.79 -to- Tiragarde Sound/0 85.01,60.36 {mode:PORTAL}",

		-- The Timeways -to- Twilight Highlands
		--"Millenia's Threshold/0 60.54,69.42 -to- Twilight Highlands/0 26.09,55.04 {mode:PORTAL}",

		-- The Timeways -to- Mechagon Island
		--"Millenia's Threshold/0 74.37,47.17 -to- Mechagon Island/0 48.13,64.31 {mode:PORTAL}",

		-- The Timeways -to- Maldraxxus
		--"Millenia's Threshold/0 77.36,61.65 -to- Maldraxxus/0 50.35,41.73 {mode:PORTAL}",

		-- The Timeways -to- Zuldazar
		--"Millenia's Threshold/0 70.42,72.70 -to- Zuldazar/0 49.50,65.36 {mode:PORTAL}",

		-- The Timeways -to- Revendreth
		"Millenia's Threshold/0 70.47,72.66 -to- Revendreth/0 77.53,47.65 {mode:PORTAL}",

		-- The Timeways -to- Revendreth
		"Millenia's Threshold/0 74.39,47.10 -to- Tazavesh/0 34.79,11.52 {mode:PORTAL}",
		...
		"Dornogal/0 29.77,59.67 -x- Vault of Memory/0 49.94,35.95 {fac:B} {mode:PORTAL} {title_atob:Click the Waygate Inside the Building to the Vault of Memory} "..
			...
			"{cond:PlayerCompletedQuest(83271) or PlayerIsOnQuest(83271) or PlayerCompletedQuest(79573)}",

		-- Dornogal -x- Azj-Kahet
		"Dornogal/0 63.61,52.59 -x- Azj-Kahet/0 57.48,41.61 {fac:B} {mode:PORTAL} {title_atob:Walk into the Tunnel to Azj-Kahet}"..
			"{title_btoa:Walk into the Tunnel to Dornogal} "..
			"{cond:PlayerCompletedQuest(78248) or PlayerCompletedQuest(79573)}",

		"The Ringing Deeps/0 49.20,44.59 -x- Isle of Dorn/0 67.35,31.01 {mode:PORTAL} {cost:10}"..
			"{title:Click lever to activate elevator}"..
			"{cond:PlayerCompletedQuest(82195)}",

		"The Ringing Deeps/0 61.53,76.95 -x- Isle of Dorn/0 37.41,72.86 {mode:PORTAL} {cost:10}"..
			"{title:Click lever to activate elevator}"..
			"{cond:PlayerCompletedQuest(84220)}",

		"Azj-Kahet/1 61.29,84.28 -to- Azj-Kahet/0 64.22,75.90 {mode:PORTAL} {cost:3} {title:Walk into the Tunnel}",

		"Azj-Kahet/0 64.22,75.90 -x- Azj-Kahet/1 61.42,75.73 {cost:0} {title:Walk into the Tunnel}",

		-- Dornogal -to- Badlands
		"Valdrakken/0 26.10,40.99 -to- Badlands/0 64.66,37.27 {mode:PORTAL} {title:Click the Portal to Badlands\ninside the building}",

		-- Dornogal -to- Val'sharah
		"Dornogal/0 48.61,48.62 -to- Val'sharah/0 51.52,58.44 {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Val'sharah}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Dornogal -to- The Jade Forest
		"Dornogal/0 48.61,48.62 -to- The Jade Forest/0 43.91,42.26 {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Jade Forest}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Dornogal -to- Winterspring
		"Dornogal/0 48.61,48.62 -to- Winterspring/0 22.78,46.76 {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Winterspring}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Dornogal -to- Northern Stranglethorn
		"Dornogal/0 48.61,48.62 -to- Northern Stranglethorn/0 79.60,77.33 {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Northern Stranglethorn}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Dornogal -to- Horrific Vision of Stormwind
		"Dornogal/0 34.67,68.29 -x- Vision of Stormwind/0 53.27,53.16 {mode:PORTAL} {title_atob:Click the Portal to the Horrific Visions}"..
			"{title_btoa:Click the Tenebrous Gateway} {cond:PlayerCompletedQuest(87328)}",

		-- Dornogal -to- Horrific Vision of Orgrimmar
		"Dornogal/0 34.67,68.29 -x- Orgrimmar Vision/0 51.89,82.74 {mode:PORTAL} {title_atob:Click the Portal to the Horrific Visions}"..
			"{title_btoa:Click the Tenebrous Gateway} {cond:PlayerCompletedQuest(87328)}",

		-- Dornogal -to- Red Dawn Arathi
		"Dornogal/0 45.97,49.21 -to- Red Dawn Arathi/0 21.97,38.88 {mode:PORTAL} {cond:(PlayerIsOnQuest(84638) or PlayerCompletedQuest(84638)) and not PlayerCompletedQuest(85529)}",
	...
	--## Neutral ##--
		...
		-- Siren Isle -to- The Ringing Deeps
		"Siren Isle/0 67.96,38.52 -x- The Ringing Deeps/0 41.92,30.23 {fac:B} {mode:PORTAL} {title_atob:Click the Mole Machine Transport and Choose |cfff0e081\"Take me to Gundargaz.\"|r} {title_btoa:Click the Mole Machine Transport and Choose |cfff0e081\"Take me to the Siren Isle.\"|r}"..
		"{cond:PlayerIsOnQuest(84720) or PlayerCompletedQuest(84720)}",

		-- Siren Isle -to- The Ringing Deeps
		"Siren Isle/0 67.96,38.52 -x- The Ringing Deeps/0 41.92,30.23 {fac:B} {mode:PORTAL} {title_atob:Click the Singing Tablet and Choose |cfff0e081\"Take me to Gundargaz.\"|r} {title_btoa:Click the Mole Machine Transport and Choose |cfff0e081\"Take me to the Siren Isle.\"|r}"..
		"{cond:PlayerIsOnQuest(84720) or PlayerCompletedQuest(84720)}",



		-- Siren Isle -to- Dornogal
		"Siren Isle/0 70.69,53.49 -x- Dornogal/0 73.55,5.29 {fac:B} {mode:PORTAL} {title_atob:Talk to Sky-Captain Cableclamp on the airship and Choose |cfff0e081\"Take me back to Dornogal.\"|r} {title_btoa:Talk to Sky-Captain Cableclamp on the airship and Choose |cfff0e081\"Take me to the Siren Isle.\"|r}"..
		"{cond:PlayerIsOnQuest(84720) or PlayerCompletedQuest(84720)}",

		-- Siren Isle -to- The Forgotten Vault
		"Siren Isle/0 50.32,15.37 -x- The Forgotten Vault/0 61.39,12.70 {fac:B} {mode:PORTAL} {title_atob:Click the Singing Tablet inside the cave and Choose |cfff0e081<Place your hand in the divot around the crystal>|r} {title_btoa:Run through the portal}"..
		"{cond:PlayerIsOnQuest(84723) or PlayerCompletedQuest(84723)}",
	...
	--## Neutral ##--
		...
		-- Undermine -x- Dornogal
		"Undermine/0 27.83,54.02 -x- Dornogal/0 52.47,50.47 {fac:B} {mode:PORTAL} {title:Step on the glowing teleport pad}"..
		"{cond:(PlayerIsOnQuest(83137) or PlayerCompletedQuest(83137) or XP.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",

		-- Undermine -x- The Ringing Deeps
		"Undermine/0 17.29,50.75 -x- The Ringing Deeps/0 72.96,73.20 {fac:B} {mode:PORTAL} {title_atob:Talk to Carli Joyride and choose |cfff0e081\<Board the drill to the Ringing Deeps.>|r} {title_btoa:Talk to Stelliya and choose |cfff0e081\<Board the drill to the Undermine.>|r}"..
		"{cond:(PlayerIsOnQuest(83151) or PlayerCompletedQuest(83151) or XP.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",

		-- Undermine -x- Kaja'Coast, Zuldazar
		"Undermine/0 18.80,52.21 -x- Zuldazar/0 22.55,54.07 {fac:B} {mode:PORTAL} {title_atob:Talk to Bigz Speedtrack and choose |cfff0e081\<Board the drill to the Kaja'Coast.>|r} {title_btoa:Click the Coastside Drill\nControl Panel and choose\n|cfff0e081\<Board the drill to the Undermine.>|r}"..
		"{cond:(PlayerIsOnQuest(83933) or PlayerCompletedQuest(83933) or XP.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
	...
	--## Neutral ##--
		...
		"Valdrakken/0 62.60,57.42 -to- The Emerald Dream/0 50.61,62.50 {mode:PORTAL} {title:Click the Portal to Central Encampment} "..
			"{cond:PlayerIsOnQuest(77572) or PlayerCompletedQuest(77887)}",
	...
	--## ALLIANCE ##--
		...
		"Valdrakken/0 59.79,41.71 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind\nInside the Building} "..
			"{cond:PlayerCompletedQuest(67030)}",
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 47.55,94.98 <region:magetower> -to- Oribos/0 20.34,50.31 {fac:A} {mode:PORTAL} {title:Click the Portal to Oribos\nInside the Portal Room} "..
			"{cond:PlayerCompletedQuest(60151) or PlayerLevel() >= 50}",
	...
	--## Neutral ##--
		...
		"Oribos/1 60.86,68.36 -to- Bastion/0 37.85,76.52    {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Bastion.'}    {cond:PlayerCompletedQuest(60156) and not XP.Parser.ConditionEnv.achieved(14281)}", -- went to Bas, not completed it yet
		-- Oribos to Revendreth (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Revendreth/0 70.00,84.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Revendreth.'} {cond:PlayerCompletedQuest(57025) and not XP.Parser.ConditionEnv.achieved(13878)}", -- went to Rev, not completed it yet
		-- Oribos to Ardenweald (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Ardenweald/0 68.00,18.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Ardenweald.'} {cond:PlayerCompletedQuest(60338) and not XP.Parser.ConditionEnv.achieved(14164)}", -- went to Ard, not completed it yet
		-- Oribos to Maldraxxus (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Maldraxxus/0 50.00,41.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Maldraxxus.'} {cond:PlayerCompletedQuest(57386) and not XP.Parser.ConditionEnv.achieved(14206)}", -- went to Mal, not completed it yet
	...
	--## Neutral ##--
		...
		"The Maw/0 48.29,41.45 -to- The Maw/0 68.89,36.60 {mode:PORTAL} {title:Talk to the Animaflow Teleporter\nChoose |cfff0e081\"Desmotaeron\"|r} "..
			"{cond:PlayerCompletedQuest(61600) and XP.Parser.ConditionEnv.achieved(15126)}",
	...
	--## ALLIANCE ##--
		...
		"Darkshore/0 48.02,36.28 -to- Boralus/0 66.81,25.06 {fac:A} {mode:PORTAL} {title:Click the Portal to Boralus Harbor} "..
			"{cond:PlayerCompletedQuest(54871) and not XP.InPhase('Old Darnassus') and XP.InPhase('Warfront Darkshore Control')}",

		-- Caverns of Time - Tanaris, Kalimdor -to- Stormwind City - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Tanaris/17 53.49,30.09 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
		...
		"Azuremyst Isle/0 20.40,54.17 -to- Darkshore/0 45.95,18.74 {fac:A} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:not XP.InPhase('Old Darnassus')}",
		...
		"Silithus/0 41.48,44.85 -to- Boralus/0 70.18,15.87 {fac:A} {mode:PORTAL} {title:Click the Portal to Tiragarde} "..
			"{cond:XP.InPhase('BFA') and not XP.InPhase('Old Silithus') and PlayerLevel() >= 10}",
		...
		"Teldrassil/0 55.03,93.72 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:XP.InPhase('Old Darnassus')}",

		-- Rut'theran Village - Darnassus, Kalimdor -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Teldrassil/0 52.27,89.47 -to- Azuremyst Isle/0 20.52,54.16 {mode:PORTAL} {cond:XP.InPhase('Old Darnassus')}",

		-- Temple of the Moon - Darnassus, Kalimdor -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Darnassus/0 44.23,78.70 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {cond:XP.InPhase('Old Darnassus')}",

		-- Temple of the Moon - Darnassus, Kalimdor (Old Time) -to- Hellfire Peninsula, Outland (Portal Usable) --
		"Darnassus/0 43.99,78.18 -to- Hellfire Peninsula/0 89.17,50.86 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10 and XP.InPhase('Old Darnassus')}",
		...
		"Darnassus/0 43.99,78.18 <override_text:You must be at least 10 to enter Outland.> <override_icon:error> -to- Hellfire Peninsula/0 89.17,50.86 {fac:A} "..
			"{mode:PORTAL} {cond:not (PlayerLevel() >= 10 and XP.InPhase('Old Darnassus'))} {cost:999}",
	...
	--## HORDE ##--
		...
		"Darkshore/0 46.24,35.11 -to- Dazar'alor/0 51.66,93.82 {fac:H} {mode:PORTAL} {title:Click the Portal to Port of Zandalar} "..
			"{cond:PlayerCompletedQuest(54416) and not XP.InPhase('Old Darnassus') and XP.InPhase('Warfront Darkshore Control')}",

		-- Caverns of Time - Tanaris, Kalimdor -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Tanaris/17 53.29,28.04 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar}",
		...
		"Northern Stranglethorn/0 37.54,50.99 -to- Undercity/0 84.58,16.33 {fac:H} {mode:PORTAL} {cond:XP.InPhase('Old Undercity')}",

		-- Northern Stranglethorn Vale, Kalimdor -to- Tirisfal Glades, Eastern Kingdoms (After Destruction) --CHECKED
		"Northern Stranglethorn/0 37.54,50.99 -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {cond:not XP.InPhase('Old Undercity') and not XP.InPhase('UndercityCharred') and not XP.InPhase('UndercityOoze')}",
		...
		"Orgrimmar/1 48.87,38.55 -to- Uldum New/0 54.90,34.25 {fac:H} {mode:PORTAL} {cond:not XP.InPhase('OldUldum') and PlayerLevel() >= 10}",
		...
		"Orgrimmar/1 50.74,55.57 -to- Tirisfal Glades L/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Portal to Ruins of Lordaeron on Top of the Zeppelin Tower} "..
			"{cond:XP.InPhase('UndercityCharred')}",
		...
		"Orgrimmar/1 57.23,88.21 -to- Azsuna/0 47.00,40.89 {fac:H} {mode:PORTAL} {title:Click the Portal to Azsuna\nDownstairs Inside the Pathfinder's Den} ",
		...
		"Orgrimmar/1 56.40,92.56 -to- Tanaris/17 54.60,28.30 {fac:H} {mode:PORTAL} "..
			"{title:Click the Portal to Caverns of Time\nDownstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality

		-- Orgrimmar - Durotar, Kalimdor -to- Warspear - Ashran, Draenor --CHECKED
		"Orgrimmar/1 55.18,92.05 -to- Warspear/0 44.42,35.53 {fac:H} {mode:PORTAL} {title:Click the Portal to Warspear, Ashran\nDownstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality

		-- Orgrimmar - Durotar, Kalimdor -to- Hall of Ancient Paths - Zuldazar, Zandalar --CHECKED
		"Orgrimmar/1 57.89,89.84 -to- Dazar'alor/1 71.96,82.78 {fac:H} {mode:PORTAL} {title:Click the Portal to Zuldazar\nDownstairs Inside the Pathfinder's Den} "..
			"{cond:XP.InPhase('BFA')}",
		...
		"Orgrimmar/1 57.51,91.65 -to- Shattrath City/0 53.01,49.21 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
			"{title:Click the Portal to Shattrath\nDownstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality
		...
		"Orgrimmar/1 57.46,92.28 -to- The Jade Forest/0 28.56,13.98 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(31769) or PlayerLevel() >= 40} "..
		...
		"Orgrimmar/1 57.11,87.30 -to- Valdrakken/0 59.55,41.46 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(67030)}"..
			"{title:Click the Portal to Valdrakken\nInside the Portal Room}",

		-- Orgrimmar - Durotar, Kalimdor -to- Silvermoon City - Everson Woods, Eastern Kingdoms --CHECKED
		"Orgrimmar/1 54.57,90.36 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon Downstairs in the Portal Room}",
		...
		"Orgrimmar/1 48.23,62.17 -to- Mulgore/0 36.49,35.11 {fac:H} {mode:PORTAL} {cond:XP:FindEvent('DARKMOON FAIRE')} "..
			"{title:Talk to the Darkmoon Faire\nMystic Mage and tell her\n|cffaaffaa\"Take me to the staging area.\"|r}",

		-- Orgrimmar -to- Razorwind Shores
		"Orgrimmar/1 58.98,89.53 -to- Razorwind Shores/0 54.31,49.32 {mode:PORTAL} {fac:H} {title_atob:Click the Portal to Razorwind Shores Inside the Pathfinder's Den}",

		-- Durotar -to- Val'sharah
		"Durotar/0 41.53,16.01 -to- Val'sharah/0 51.52,58.44 {fac:H} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Val'sharah}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Durotar -to- The Jade Forest
		"Durotar/0 41.53,16.01 -to- The Jade Forest/0 43.91,42.26 {fac:H} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Jade Forest}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Durotar -to- Winterspring
		"Durotar/0 41.53,16.01 -to- Winterspring/0 22.78,46.76 {fac:H} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Winterspring}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Durotar -to- Northern Stranglethorn
		"Durotar/0 41.53,16.01 -to- Northern Stranglethorn/0 79.60,77.33 {fac:H} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Northern Stranglethorn}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",
	...
	--## NEUTRAL ##--
		...
		"Darnassus/0 36.79,50.44 -x- Teldrassil/0 55.07,88.38 {mode:PORTAL} {template:pinkportal} {cond:XP.InPhase('Old Darnassus')}",
		...
		"Silithus/0 43.20,44.50 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {title:Click the Titan Translocator} "..
			"{cond:XP.InPhase('BFA') and not XP.InPhase('Old Silithus')}",

			-- Zidormi Phase -to- Present Day Silithus --CHECKED
			"Silithus/0 78.93,21.97 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {cond:XP.InPhase('BFA') and XP.InPhase('Old Silithus')} "..
		...
		"Mulgore/0 36.85,35.86 -to- Darkmoon Island/0 51.29,23.86 {mode:PORTAL} {cond:XP:FindEvent('DARKMOON FAIRE')} "..
	...
	--## ALLIANCE ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Stormshield/0 31.71,52.48 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10 and not XP.InPhase('Old Blasted Lands')} "..
		...
		"Blasted Lands/0 55.01,54.27 <override_text:You must be at least 10 to enter Draenor.> <override_icon:error> -to- Stormshield/0 31.71,52.48 {fac:A} "..
			"{mode:PORTAL} {cond:PlayerLevel() < 10 and not XP.InPhase('Old Blasted Lands')} {template:darkportalred} {cost:999}",

		-- Goldshire - Elynn Forest, Eastern Kingdoms -to- Darkmoon Island --CHECKED
		"Elwynn Forest/0 41.79,69.48 -to- Darkmoon Island/0 51.29,23.86 {mode:PORTAL} {cond:XP:FindEvent('DARKMOON FAIRE')} "..
			"{title:Click the Portal to the Darkmoon Faire}",
		...
		"Stormwind City/0 75.24,20.50 -to- Uldum New/0 54.90,34.25 {fac:A} {mode:PORTAL} {cond:not XP.InPhase('OldUldum')}}",
		...
		"Stormwind City/0 42.08,91.34 <region:magetower> -to- Azsuna/0 47.00,40.89 {fac:A} {mode:PORTAL} "..
		...
		"Stormwind City/0 41.36,89.82 <region:magetower> -to- Stormshield/0 31.71,52.48 {fac:A} {mode:PORTAL} "..
		...
		"Stormwind City/0 40.85,92.75 <region:magetower> -to- Boralus/0 70.62,16.98 {fac:A} {mode:PORTAL}"..
		...
		"Stormwind City/0 48.89,93.43 <region:magetower> -to- Valdrakken/0 59.55,41.46 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(67030)}"..
			"{title:Click the Portal to Valdrakken\nInside the Mage Tower}",
		...
		"Arathi Highlands/0 21.96,65.15 -to- Boralus/0 66.81,25.06 {fac:A} {mode:PORTAL} {title:Click the Portal to Boralus Harbor} "..
			"{cond:PlayerCompletedQuest(53198) and not XP.InPhase('Old Arathi') and XP.InPhase('Warfront Arathi Control')}",

		-- Stormwind City - Elwynn Forest, Kalimdor -to- Darkmoon Island
		"Stormwind City/0 62.26,72.96 -to- Elwynn Forest/0 41.87,68.17 {fac:A} {mode:PORTAL} {cond:XP:FindEvent('DARKMOON FAIRE')} "..
			"{title:Talk to the Darkmoon Faire\nMystic Mage and tell her\n|cffaaffaa\"Take me to the staging area.\"|r}",

		-- Stormwind - Elwynn Forest, Eastern Kingdoms -to- Founder's Point - Thaldraszus, Dragon Isles
		"Stormwind City/0 46.85,93.45 <region:magetower> -to- Founder's Point/0 57.43,26.62 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(93057)}"..
			"{title_atob:Click the Portal to Founder's Point\nInside the Mage Tower}",

		-- Elwynn Forest -to- Val'sharah
		"Elwynn Forest/0 34.53,51.43 -to- Val'sharah/0 51.52,58.44 {fac:A} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Val'sharah}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Elwynn Forest -to- The Jade Forest
		"Elwynn Forest/0 34.53,51.43 -to- The Jade Forest/0 43.91,42.26 {fac:A} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Jade Forest}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Elwynn Forest -to- Winterspring
		"Elwynn Forest/0 34.53,51.43 -to- Winterspring/0 22.78,46.76 {fac:A} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Winterspring}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",

		-- Elwynn Forest -to- Northern Stranglethorn
		"Elwynn Forest/0 34.53,51.43 -to- Northern Stranglethorn/0 79.60,77.33 {fac:A} {mode:PORTAL} {title:Click the Scenic Getaway Portal and choose Northern Stranglethorn}"..
			"{cond:XP.Parser.ConditionEnv.isevent('Love is in the Air')}",
	...
	--## HORDE ##--
		...
		"Arathi Highlands/0 27.44,29.38 -to- Dazar'alor/0 51.66,93.82 {fac:H} {mode:PORTAL} {title:Click the Portal to Port of Zandalar} "..
			"{cond:PlayerCompletedQuest(53212) and not XP.InPhase('Old Arathi') and XP.InPhase('Warfront Arathi Control')}",
		...
		"Blasted Lands/0 72.65,49.51 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and not XP.InPhase('Old Blasted Lands')}",
		...
		"Silvermoon City/0 49.49,14.80 -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Orb of Translocation} "..
			"{cond:not XP.InPhase('Old Undercity') and not XP.InPhase('UndercityCharred') and not XP.InPhase('UndercityOoze')}",
		...
		"Tirisfal Glades/0 60.74,58.67 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:XP.InPhase('Old Undercity')}"..
		...
		"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and XP.InPhase('Old Undercity')}",
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Silvermoon City) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Grom'gol) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",
		...
		-- Tirisfal Glades, Eastern Kingdoms (Old Time) -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Tirisfal Glades L/0 59.50,66.95 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityCharred')}",

		-- Tirisfal Glades, Eastern Kingdoms (Old Time) -to- Vengeance Landing - Howling Fjord, Northrend --CHECKED
		"Tirisfal Glades L/0 60.11,66.93 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:XP.InPhase('UndercityCharred')}",
		...
		-- Undercity - Tirisfal Glades, Eastern Kingdoms -to- The Stair of Destiny - Hellfire Peninsula, Outland (Portal Usable) --CHECKED
		--"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and XP.InPhase('UndercityCharred')}",
	...
	--## NEUTRAL ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Hellfire Peninsula/0 89.56,50.22 {mode:PORTAL} {cond:PlayerLevel() >= 10 and XP.InPhase('Old Blasted Lands')} "..
			"{template:darkportal}",
	...
	--## NEUTRAL ##--
		...
		--"{cond:not XP:RaceClassMatch('MAGE')}",
	...
	--## ALLIANCE ##--
		...
		"Vale of Eternal Blossoms New/0 91.59,64.30 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:not XP.InPhase('OldVale')}",
	...
	--## HORDE ##--
		...
		"Durotar 66,1 <title:Hellscream's Fist Airship> -to- The Jade Forest 28.5,14.0 {fac:H} {mode:PORTAL} "..
			"{cond:PlayerLevel()>=10 and PlayerLevel() < 50  and not PlayerCompletedQuest(31769) and not XP.IsLegionOn()}",
		...
		"Vale of Eternal Blossoms New/0 63.72,9.89 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:not XP.InPhase('OldVale')}",
	...
	--## NEUTRAL ##--
		...
		-- Stormheim -to- Helheim
		"Stormheim/0 73.70,39.29 -to- Helheim/0 66.25,47.63 {mode:PORTAL} {title:Enter the Portal\nBeneath the Platform}",

		-- Helheim -to- Stormheim
		"Helheim/0 66.83,48.14 -to- Stormheim/0 73.54,39.51 {mode:PORTAL} {title:Enter the Portal}",
		...
		"Dalaran L/10 49.26,47.62 -to- Dalaran L/12 63.38,23.87 {mode:PORTAL} {title:Step on the glowing pad inside the building} {cond:XP.IsLegionOn()}",

		-- Chamber of the Guardian Interior - Dalaran, Broken Isles -to- Chamber of the Guardian Entrance - Dalaran, Broken Isles --
		"Dalaran L/12 64.88,21.12 -to- Dalaran L/10 49.04,48.04 {mode:PORTAL} {title:Step on the glowing pad inside the building} {cond:XP.IsLegionOn()}",
		...
		"Dalaran L/10 23.10,-11.40 <region:dalaran_margosss_retreat> -to- Dalaran L/10 60.92,44.72 {mode:PORTAL} {cond:XP.IsLegionOn()} "..
	...
	--## ALLIANCE ##--		
		...
		"Tiragarde Sound/0 74.38,23.41 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {title:Click the Portal to Exodar Inside the Building} {cond:XP.InPhase('BFA') or PlayerLevel() >= 50}}",

		-- Sanctum of the Sages - Boralus Harbor, Tiragarde Sound -to- Ironforge - Dun Morogh, Eastern Kingdoms --
		"Tiragarde Sound/0 74.49,23.50 -to- Ironforge/0 25.51,8.43 {fac:A} {mode:PORTAL} {title:Click the Portal to Ironforge Inside the Building} {cond:XP.InPhase('BFA') or PlayerLevel() >= 50}}",
		...
		"Boralus/0 69.65,15.92 -to- Silithus/0 41.41,45.19 {fac:A} {mode:PORTAL} {title:Click the Portal to Silithus Inside the Building} "..
			"{cond:XP.InPhase('BFA') and not XP.InPhase('Old Silithus') and PlayerLevel() >= 50}",
		...
		"Boralus/0 70.13,16.79 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind Inside the Building} "..
			"{cond:XP.InPhase('BFA') or PlayerLevel() >= 50}",
	...
	--## ALLIANCE ##--
		...
		"Boralus/0 66.19,24.72 -to- Arathi Highlands/0 21.58,65.14 {fac:A} {mode:PORTAL} {title:Click the Portal to Arathi Highlands} "..
			"{cond:XP.InPhase('Warfront Arathi Control') and PlayerCompletedQuest(53194)}",
		...
		"Boralus/0 66.22,24.42 -to- Darkshore/0 46.72,34.73 {fac:A} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:XP.InPhase('Warfront Darkshore Control') and PlayerCompletedQuest(53194)}",
	...
	--## HORDE ##--
		...
		--"Dazar'alor/0 49.94,43.85 -to- Orgrimmar/1 40.67,77.43 {fac:H} {mode:PORTAL} {cond:XP:RaceClassMatch('ZANDALARITROLL')}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Silvermoon City, Eversong Woods --
		"Dazar'alor/1 73.99,62.22 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon City Inside the Building} {cond:XP.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Orgrimmar - Durotar, Kalimdor --
		"Dazar'alor/1 74.05,69.75 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar Inside the Building} {cond:XP.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Thunder Bluff - Mulgore, Kalimdor --
		"Dazar'alor/1 73.60,77.38 -to- Thunder Bluff/0 22.21,16.87 {fac:H} {mode:PORTAL} {title:Click the Portal to Thunder Bluff Inside the Building} {cond:XP.InPhase('BFA') or PlayerLevel() >= 50}",
		...
		"Dazar'alor/0 51.92,94.59 -to- Arathi Highlands/0 27.40,29.95 {fac:H} {mode:PORTAL} {title:Click the Portal to Ar'gorok} "..
			"{cond:XP.InPhase('Warfront Arathi Control') and PlayerCompletedQuest(53208)}",
		...
		"Dazar'alor/0 51.99,94.55 -to- Darkshore/0 46.31,35.00 {fac:H} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:XP.InPhase('Warfront Darkshore Control') and PlayerCompletedQuest(53208)}",
	...
	-- VOID ELF
		...
		"Stormwind City/0 50.68,8.45 -to- Telogrus Rift/0 27.69,28.10 {fac:A} {mode:PORTAL} {title_atob:Click the Rift to Telogrus} {cond:PlayerCompletedQuest(79010)}",
	...
	-- HIGHMOUNTAIN TAUREN
		"Thunder Totem/6 46.04,63.74 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar} {cond:XP:RaceClassMatch('HIGHMOUNTAINTAUREN')}",

		"Orgrimmar/1 38.15,75.28 -to- Thunder Totem/6 44.18,64.07 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Thunder Totem} {cond:XP:RaceClassMatch('HIGHMOUNTAINTAUREN')}",


	-- NIGHTBORNE
		"Suramar/0 58.18,87.33 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar\non the Platform} {cond:XP:RaceClassMatch('NIGHTBORNE')}",

		"Orgrimmar/1 38.59,75.89 -to- Suramar/0 59.55,85.29 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to The Nighthold} {cond:XP:RaceClassMatch('NIGHTBORNE')}",
...
-------------------------
	...
	--## HORDE ##--
		...
		-- Echo Isles - Durotar, Kalimdor -x- Zuldazar - Zandalar --CHECKED
		"Echo Isles/0 70.93,38.23 -x- Zuldazar/0 58.03,65.05 {fac:H} {mode:ZEPPELIN}",
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 18.02,25.84 -x- Borean Tundra/0 59.68,69.41 {fac:A} {mode:SHIP} {cost:177}  {cond:not XP.IsLegionBoatLock()}",
	...
	--## HORDE ##--
		...
		"Zuldazar/0 58.02,65.07 -x- Echo Isles/0 70.90,38.23 {fac:H} {mode:SHIP} {cond:XP.InPhase('BFA')}",
...
------------------
		...
		-- Teleport: Darnassus --
		"Darkshore/0 45.95,18.74				<spell:3565>	<faction:A>	<cond:not XP.InPhase('Old Darnassus')>",
		"Darnassus/0 43.47,78.67				<spell:3565>	<faction:A>	<cond:XP.InPhase('Old Darnassus')>",
		-- Teleport: Ironforge --
		...
		"Vale of Eternal Blossoms/0 86.30,61.05			<spell:132621>	<faction:A>	<cond:XP.InPhase('Old Vale')>",
		"Vale of Eternal Blossoms New/0 86.85,59.09		<spell:132621>	<faction:A>	<cond:not XP.InPhase('Old Vale')>",
		...
		-- Teleport: Vale of Eternal Blossoms --
		"Vale of Eternal Blossoms/0 62.21,21.54			<spell:132627> <faction:H>	<cond:XP.InPhase('Old Vale')>",
		"Vale of Eternal Blossoms New/0 62.68,19.30		<spell:132627> <faction:H>	<cond:not XP.InPhase('Old Vale')>",
		-- Teleport: Warspear --
		...
		-- DK (DEATHGATE)
		"Eastern Plaguelands 83.72,50.03			<spell:50977> <subtype:deathgate> <cond:not (PlayerCompletedQuest(38990) or PlayerCompletedQuest(40935) or PlayerCompletedQuest(40740))>", --Class based!
		-- MONKS (Zen Pilgrimage)
		"Kun-Lai Summit 48.64,42.94				<spell:126892> <subtype:zenpilgrimage> <region:peak_of_serenity> <cond:not PlayerCompletedQuest(40236)>", --Class based!
		...
		-- DRUID
			"Emerald Dreamway/0 35.33,53.15 <spell:193753> <cond:XP.CurrentMapID~=715>",

		-- DEATHKNIGHT
			"Broken Shore/2 27.43,30.43 <spell:50977> <subtype:deathgate> <cond:(PlayerCompletedQuest(38990) or PlayerCompletedQuest(40935) or PlayerCompletedQuest(40740)) and XP.CurrentMapID~=647 and XP.CurrentMapID~=648  and XP.CurrentMapID~=646>",

		-- MONK (Zen Pilgrimage)
			"The Wandering Isle L/0 51.46,48.65 <spell:126892> <subtype:zenpilgrimage> <cond:PlayerCompletedQuest(40236) and XP.CurrentMapID~=709>",
		...
		"Nagrand D/0 50.35,57.21 -x- Nagrand/0 41.27,59.04 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Nagrand D/0 88.36,22.84 -x- Zangarmarsh/0 68.20,88.46 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", -- On top of the mushroom --
		"Nagrand D/0 71.41,21.94 -x- Nagrand/0 60.36,25.56 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Nagrand D/0 81.13,8.97 -x- Zangarmarsh/0 49.19,55.37 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}",  -- Underwater on top of the mushroom 
		"Frostfire Ridge/0 21.82,45.31 -x- Blade's Edge Mountains/0 46.40,64.05 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", -- On top of the bridge --
		"Frostfire Ridge/0 37.53,60.71 -x- Blade's Edge Mountains/0 39.63,77.39 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Gorgrond/0 49.41,73.66 -x- Blade's Edge Mountains/0 59.11,71.69 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Gorgrond/0 50.82,31.43 -x- Blade's Edge Mountains/0 66.20,26.33 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Tanaan Jungle/0 70.30,54.53 -x- Hellfire Peninsula/0 80.38,51.60 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Tanaan Jungle/0 49.56,50.73 -x- Hellfire Peninsula/0 54.98,48.87 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Tanaan Jungle/0 56.34,26.83 -x- Hellfire Peninsula/0 64.04,21.73 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Shadowmoon Valley D/0 60.02,48.37 -x- Shadowmoon Valley/0 61.53,46.07 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Shadowmoon Valley D/0 32.33,28.76 -x- Shadowmoon Valley/0 27.10,33.36 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Spires of Arak/0 47.40,12.45 -x- Terokkar Forest/0 70.78,75.88 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Talador/0 57.85,80.53 -x- Terokkar Forest/0 45.37,47.53 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Talador/0 50.41,35.19 -x- Terokkar Forest/0 35.26,12.51 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
		"Talador/0 68.42,9.32 -x- Zangarmarsh/0 82.59,66.13 {mode:PORTAL} {template:toylocation} {cond:PlayerHasToy(129929) and PlayerLevel()>=40} {arrivaltoy:129929}", 
}
