...
data.basenodes.inns = {
	...
	["Tazavesh"]={
		{name="Shan'dorah",faction="B",npc="Ba'orr",npcid=235079,x=41.13,y=25.10},
	},

	["K'aresh"]={
		{name="Shan'dorah",faction="B",npc="Darkhearth Roselym",npcid=238572,x=60.72,y=27.64},
		{name="The Oasis",faction="B",npc="Om'volt",npcid=241507,x=76.73,y=34.43},
		{name="Overlook Zo'Shuul",faction="B",npc="Ta'rant",npcid=236097,x=48.69,y=38.45},
		{name="Eco-Dome: Primus",faction="B",npc="Silmar",npcid=245405,x=49.98,y=59.47},
	},

	["Undermine"]={
		{name="The Incontinental Hotel",faction="B",npc="Paks Topskimmer",npcid=231045,x=43.50,y=51.69},
	},

	["Siren Isle"]={
		{name="Flotsam Shoal",faction="B",npc="Snizzle Fumblecrank",npcid=228390,x=68.98,y=46.44},
		{name="Flotsam Shoal",faction="B",npc="Byron Nailstew",npcid=228106,x=71.40,y=37.44},
	},

	["Dornogal"]={
		{name="Dornogal",faction="B",npc="Ronesh",npcid=212370,x=44.73,y=46.40},
	},
	...
	["Stormwind City"]={
		...
		{name="Stormwind City",faction="A",x=55.84,y=317.46}, -- boosted chars spawn location, not possible to set as location once unset
	},
	["Loch Modan"]={
