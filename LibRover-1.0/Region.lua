...
function Region:New(data)
	...
	self.centernode = self.centernode or ( x1 and LibRover_Node:New{c=XP.GetMapContinent(m1),m=m1,f=f1,x=x1,y=y1,id=id1,type="misc"} ) or Lib.nodes.id[self.centernodeid] or Lib.nodes.id[id1]
