...
data.point_context_templates = {
	...
	{'whistle',"Use the Flight Master's Whistle"},
	{'taxi_taxi__taxi_taxi',"passfp"},
	{'taxi_ferry__taxi_ferry',"passfp"},
	{'forced_taxi__taxi_taxi',"Arrive at {name},\nthen Fly to {next_name}"},
	{'forced_ferry__taxi_ferry',"Arrive at {name},\nthen Ferry to {next_name}"},
	...
	{'taximaybe',"Talk to {npc}\nTry to Fly to {next_name}"},
	{'eternalgateway',"Activate Teleport Pad\nTeleport to {next_name}"},
	...
	{'pinkportal',"Enter the Portal to {next_map}"},
	{'*_*__pinkportal_*',"Enter the Portal\nto {next_map}"},
	{'*_*__darkportal_*',"Enter the Portal\nto {next_map}"},
	{'*_*__darkportalred_*',"Enter the Portal\nto {next_map}"},
	{'darkportal',"Enter the Portal\nto {next_map}"},
	{'darkportalred',"Enter the Portal\nto {next_map}"},
	{'*_*__cityportal_*',"Enter the Portal\nto {next_map}"},
	{'cityportal',"Enter the Portal\nto {next_map}"},
	...
	{'zerethlocus',"Use the Locus Shift\nTeleport to {next_name}"},
	{'ancientwaygate',"Use the Ancient Waygate\nTeleport to {next_name}"},
	{'phaseconduit',"Use the Phase Conduit\nTeleport to {next_name}"},

	{'toylocation',"Use {arrivaltoy} Here\nOpen a Portal to {next_map}"},
	{'*_*__toylocation_*',"Use {arrivaltoy} Here\nOpen a Portal to {next_map}"},
	{'arcantina',"Use {item}\nand return to"},
