...
-- Support CUSTOM_CLASS_COLORS (community standard for class color overrides)
-- Falls back to RAID_CLASS_COLORS if not present, and listens for late-loading addons
