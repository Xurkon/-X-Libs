...
--- Fix phased continents (BFA compatibility)
-- Fixes issues with Teldrassil not being reported in Kalimdor's children
function HereBeDragons:FixPhasedContinents()
    -- Teldrassil isn't reported as being in Kalimdor#12's children anymore.
    self.processMap(57, C_Map.GetMapInfo(57))
    self.processMapChildrenRecursive(57)
end
