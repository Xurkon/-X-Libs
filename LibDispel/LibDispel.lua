local MAJOR, MINOR = "LibDispel-1.0", 99
...
local C_SpellBook = _G.C_SpellBook or {
  IsSpellInSpellBook = _G.IsSpellKnown or _G.IsPlayerSpell,
  IsSpellKnown = _G.IsSpellKnown or _G.IsPlayerSpell,
}
...
local IsSpellInSpellBook = C_SpellBook.IsSpellInSpellBook or _G.IsSpellKnownOrOverridesKnown or _G.IsPlayerSpell
local IsSpellKnown = C_SpellBook.IsSpellKnown or _G.IsPlayerSpell
