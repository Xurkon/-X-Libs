...
local MAJOR, MINOR = "AceConfigDialog-3.0", 1000085
...
-- Lua APIs
local tinsert, tsort, tremove, wipe, tconcat = table.insert, table.sort, table.remove, table.wipe, table.concat
local strmatch, format = string.match, string.format
local assert, loadstring, error = assert, loadstring, error
local pairs, next, select, type, unpack, ipairs = pairs, next, select, type, unpack, ipairs
local tostring, tonumber, rawset = tostring, tonumber, rawset
